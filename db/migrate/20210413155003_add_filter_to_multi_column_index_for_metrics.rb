class AddFilterToMultiColumnIndexForMetrics < ActiveRecord::Migration[6.1]
  ...
  LICENSE_USAGE_INCREMENTED_EVENT_TYPE_ID = '5aa96b0b-5c75-46c6-b732-9ddeb3917627'
  LICENSE_USAGE_DECREMENTED_EVENT_TYPE_ID = '4048a859-dac4-4ddd-9dc9-ad79f3c7660a'
  ...
  FILTERED_EVENT_TYPE_IDS = [
    ...
    LICENSE_USAGE_INCREMENTED_EVENT_TYPE_ID,
    LICENSE_USAGE_DECREMENTED_EVENT_TYPE_ID,
