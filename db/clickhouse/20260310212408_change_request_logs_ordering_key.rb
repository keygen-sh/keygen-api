...
class ChangeRequestLogsOrderingKey < ActiveRecord::Migration[8.1]
  verbose!
  ...
  def up
    ...
    add_index :request_logs_tmp, :environment_id, name: 'idx_environment', type: 'bloom_filter', granularity: 4
