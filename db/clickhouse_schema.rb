...
ActiveRecord::Schema[8.1].define(version: 2026_04_01_150330) do
  ...
  create_table "request_logs_tmp", id: :uuid, options: "ReplacingMergeTree(ver, is_deleted) PARTITION BY toYYYYMMDD(created_date) ORDER BY (account_id, created_date, id)", ttl: "created_at + toIntervalSecond(ttl)", settings: "index_granularity = 8192", force: :cascade do |t|
    t.uuid "id", null: false
    t.uuid "account_id", null: false
    t.uuid "environment_id"
    t.datetime "created_at", precision: 3, null: false
