...
class Account < ApplicationRecord
  ...
  def set_autogenerated_name!
    ...
    if autogen_slug.nil? || PUBLIC_EMAIL_DOMAINS.include?(host) || Account.exists?(slug: autogen_slug)
      autogen_name = user
    end

    # Generate a random name if the autogen'd slug is taken
