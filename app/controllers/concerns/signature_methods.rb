...
module SignatureMethods
  ...
  SUPPORTED_SIGNATURE_ALGORITHMS = %w[ed25519 rsa-pss-sha256 rsa-sha256 ecdsa-secp256r1].freeze
  ...
  def sign_response_data(algorithm:, account:, data:)
    ...
    when 'ecdsa-secp256r1'
      sign_with_ecdsa_secp256r1(key: account.ecdsa_private_key, data: data.to_s)
    end
  rescue => e
  ...
  def sign_with_ecdsa_secp256r1(key:, data:)
    digest = OpenSSL::Digest::SHA256.new
