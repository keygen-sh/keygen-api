        ...
        param :data, type: :hash do
          ...
          param :attributes, type: :hash, optional: true do
            ...
            if current_bearer&.has_role?(:admin, :developer, :sales_agent, :product)
              ...
              param :max_machines, type: :integer, optional: true, allow_nil: true, transform: -> k, v { [:max_machines_override, v] }
              param :max_cores, type: :integer, optional: true, allow_nil: true, transform: -> k, v { [:max_cores_override, v] }
              param :max_uses, type: :integer, optional: true, allow_nil: true, transform: -> k, v { [:max_uses_override, v] }
            end
