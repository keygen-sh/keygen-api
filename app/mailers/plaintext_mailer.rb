  ...
  def prompt_for_review(account:)
    ...
    mail(
      ...
      body: <<~TXT
        ...
        Do you have a few minutes today to give us a quick review on Capterra so more companies can find us? As a thank you, all verified reviews will receive a $20 Amazon gift card (or $40 account credit).
