...
class RenameOwnerRelationshipToUserForLicenseMigration < BaseMigration
  ...
  response if: -> res { res.status < 400 && res.request.params in controller: 'api/v1/licenses' | 'api/v1/licenses/actions/validations' | 'api/v1/licenses/actions/uses' | 'api/v1/licenses/actions/permits' |
