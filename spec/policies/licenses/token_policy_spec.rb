...
describe Licenses::TokenPolicy, type: :policy do
  ...
  with_role_authorization :admin do
    with_scenarios %i[accessing_a_license accessing_its_tokens] do
      with_token_authentication do
        with_permissions %w[license.tokens.read] do
  ...
  with_role_authorization :user do
    with_scenarios %i[is_licensed accessing_its_license accessing_its_tokens] do
      with_token_authentication do
        with_wildcard_permissions { denies :index }
        with_default_permissions  { denies :index }
        without_permissions       { denies :index }
    ...
    with_scenarios %i[is_licensed accessing_its_license accessing_its_token] do
      with_token_authentication do
        with_wildcard_permissions do
          denies :show, :create
        end
