...
describe Users::LicensePolicy, type: :policy do
  subject { described_class.new(record, account:, environment:, bearer:, token:, user:) }

  with_role_authorization :admin do
    with_scenarios %i[accessing_a_user accessing_its_licenses] do
    ...
    with_scenarios %i[accessing_a_user accessing_its_license] do
      with_token_authentication do
        with_permissions %w[license.read] do
    ...
    with_scenarios %i[accessing_another_account accessing_a_user accessing_its_license] do
      with_token_authentication do
        with_permissions %w[license.read] do
          denies :show
        end
  ...
  with_role_authorization :user do
    ...
    with_bearer_trait :with_teammates do
      with_scenarios %i[accessing_its_teammate accessing_its_licenses] do
        with_token_authentication do
          with_permissions %w[license.read] do
            denies :index
          end
      ...
      with_scenarios %i[accessing_its_teammate accessing_its_license] do
        with_token_authentication do
          with_permissions %w[license.read] do
            denies :show
          end
