...
describe Groups::UserPolicy, type: :policy do
  ...
  with_role_authorization :admin do
    ...
    with_scenarios %i[accessing_another_account accessing_a_group accessing_its_users] do
      with_token_authentication do
        with_permissions %w[group.users.read] do
          denies :index
        end
    ...
    with_scenarios %i[accessing_another_account accessing_a_group accessing_its_user] do
      with_token_authentication do
        with_permissions %w[group.users.read] do
          denies :show
        end
  ...
  with_role_authorization :license do
    with_scenarios %i[accessing_its_group accessing_its_users] do
      with_token_authentication do
        with_wildcard_permissions { denies :index }
        with_default_permissions  { denies :index }
        without_permissions       { denies :index }
    ...
    with_scenarios %i[accessing_its_group accessing_its_user] do
  ...
  with_role_authorization :user do
    with_scenarios %i[accessing_a_group as_group_owner accessing_its_users] do
      with_token_authentication do
        with_permissions %w[group.users.read] do
          without_token_permissions { denies :index }
    ...
    with_scenarios %i[accessing_a_group as_group_owner accessing_its_user] do
      with_token_authentication do
        with_permissions %w[group.users.read] do
          without_token_permissions { denies :show }
