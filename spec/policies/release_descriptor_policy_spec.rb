...
describe ReleaseDescriptorPolicy, type: :policy do
  subject { described_class.new(record, account:, environment:, bearer:, token:) }

  with_role_authorization :admin do
    with_scenarios %i[accessing_descriptors] do
    ...
    with_scenarios %i[accessing_a_descriptor] do
      with_token_authentication do
    ...
    with_scenarios %i[accessing_another_account accessing_descriptors] do
      with_token_authentication do
        with_permissions %w[artifact.read release.read] do
          denies :index
        end
    ...
    with_scenarios %i[accessing_another_account accessing_a_descriptor] do
      with_token_authentication do
        with_permissions %w[artifact.read] do
          denies :show
        end
  ...
  with_role_authorization :product do
    with_scenarios %i[accessing_its_descriptors] do
      with_token_authentication do
        with_permissions %w[artifact.read release.read] do
          without_token_permissions { denies :index }
    ...
    with_scenarios %i[accessing_its_descriptor] do
      with_token_authentication do
        with_permissions %w[artifact.read] do
          without_token_permissions { denies :show }
  ...
  with_role_authorization :license do
    ...
    with_scenarios %i[accessing_descriptors] do
      with_descriptor_traits %i[open] do
        with_license_authentication do
          with_permissions %w[artifact.read] do
            allows :index
          end
