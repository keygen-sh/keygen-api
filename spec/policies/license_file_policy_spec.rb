...
describe LicenseFilePolicy, type: :policy do
  subject { described_class.new(record, account:, environment:, bearer:, token:) }

  with_role_authorization :admin do
    with_scenarios %i[accessing_a_license accessing_its_license_file] do
    ...
    with_scenarios %i[accessing_another_account accessing_a_license accessing_its_license_file] do
      with_token_authentication do
        with_permissions %w[license.read] do
          denies :show
        end
  ...
  with_role_authorization :product do
    with_scenarios %i[accessing_its_license accessing_its_license_file] do
      with_token_authentication do
        with_permissions %w[license.read] do
          without_token_permissions { denies :show }
  ...
  with_role_authorization :license do
    with_scenarios %i[accessing_itself accessing_its_license_file] do
