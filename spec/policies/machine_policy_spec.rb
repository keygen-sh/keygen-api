...
describe MachinePolicy, type: :policy do
  ...
  with_role_authorization :user do
    with_scenarios %i[is_licensed accessing_its_machines] do
      with_token_authentication do
        with_permissions %w[machine.read] do
          allows :index
        end
    ...
    with_scenarios %i[is_licensed accessing_its_machine] do
      with_token_authentication do
        with_permissions %w[machine.read] do
          without_token_permissions { denies :show }
    ...
    with_scenarios %i[is_licensed accessing_machines] do
      with_token_authentication do
        with_permissions %w[machine.read] do
          denies :index
        end
    ...
    with_scenarios %i[is_licensed accessing_a_machine] do
      with_token_authentication do
        with_permissions %w[machine.read] do
          denies :show
        end
