...
namespace :stripe do
  ...
  task stats: :environment do
    Rails.logger.silence do
      ...
      s << "\e[34m======================\e[0m\n"
      s << "\e[34mMonthly Recurring Revenue: \e[32m#{report.monthly_recurring_revenue.to_fs(:currency)}\e[34m (#{report.pending_revenue.to_fs(:currency)} pending conversion)\e[0m\n"
      s << "\e[34mAnnual Run Rate: \e[32m#{report.annual_run_rate.to_fs(:currency)}\e[0m\n"
      s << "\e[34mNew Revenue: \e[32m#{report.new_revenue.to_fs(:currency)}/mo\e[34m (#{report.net_new_revenue.to_fs(:currency)} net)\e[0m\n"
      s << "\e[34mLost Revenue: \e[31m#{report.lost_revenue.to_fs(:currency)}/mo\e[0m\n"
      s << "\e[34mRevenue Growth Rate: \e[32m#{report.revenue_growth_rate.to_fs(:percentage, precision: 2)}\e[0m\n"
      s << "\e[34mConversion Rate:\e[0m\n"
      s << "\e[34m  - Past 90 Days: \e[36m#{report.conversion_rate_90d.to_fs(:percentage, precision: 2)}\e[0m\n"
      s << "\e[34m  - 1 Year: \e[36m#{report.conversion_rate_1y.to_fs(:percentage, precision: 2)}\e[0m\n"
      s << "\e[34m  - YTD: \e[36m#{report.conversion_rate_ytd.to_fs(:percentage, precision: 2)}\e[0m\n"
      s << "\e[34mChurn Rate: \e[31m#{report.churn_rate.to_fs(:percentage, precision: 2)}\e[0m\n"
      s << "\e[34mUser Growth Rate:\e[0m\n"
      s << "\e[34m  - Overall: \e[32m#{report.user_growth_rate.to_fs(:percentage, precision: 2)}\e[0m\n"
      s << "\e[34m  - Paid: \e[32m#{report.paid_user_growth_rate.to_fs(:percentage, precision: 2)}\e[0m\n"
      s << "\e[34mForecasted Revenue:\e[0m\n"
      s << "\e[34m  - Next 4 Weeks: \e[32m#{report.forecasted_revenue_4w.to_fs(:currency)}/mo\e[34m (with #{report.revenue_growth_rate.to_fs(:percentage, precision: 2)} growth rate)\e[0m\n"
      s << "\e[34m  - 3 Months: \e[32m#{report.forecasted_revenue_3m.to_fs(:currency)}/mo\e[0m\n"
      s << "\e[34m  - 6 Months: \e[32m#{report.forecasted_revenue_6m.to_fs(:currency)}/mo\e[0m\n"
      s << "\e[34m  - 1 Year: \e[32m#{report.forecasted_revenue_1y.to_fs(:currency)}/mo\e[0m\n"
      s << "\e[34mAverage Revenue Per-User: \e[32m#{report.average_revenue_per_user.to_fs(:currency)}/mo\e[0m\n"
      s << "\e[34mAverage Lifetime Value: \e[32m#{report.average_life_time_value.to_fs(:currency)}\e[0m\n"
      s << "\e[34mAverage Lifetime: \e[36m#{report.average_subscription_length_per_user.to_fs(:rounded, precision: 2)} months\e[0m\n"
      s << "\e[34mTime-to-Convert:\e[34m (n=#{report.to_convert_sample_size})\e[0m\n"
      s << "\e[34m  - Latest: \e[36m#{report.latest_time_to_convert.to_fs(:rounded, precision: 2)} days\e[34m (#{report.latest_converted_user.email} signed up #{time_ago_in_words(report.latest_converted_user.created)} ago)\e[0m\n"
      s << "\e[34m  - Average: \e[36m#{report.average_time_to_convert.to_fs(:rounded, precision: 2)} days\e[0m\n"
      s << "\e[34m  - Median: \e[36m#{report.median_time_to_convert.to_fs(:rounded, precision: 2)} days\e[0m\n"
      s << "\e[34m  - P90: \e[36m#{report.p90_time_to_convert.to_fs(:rounded, precision: 2)} days\e[0m\n"
      s << "\e[34m  - P95: \e[36m#{report.p95_time_to_convert.to_fs(:rounded, precision: 2)} days\e[0m\n"
      s << "\e[34m  - P99: \e[36m#{report.p99_time_to_convert.to_fs(:rounded, precision: 2)} days\e[0m\n"
      s << "\e[34mTime-on-Free:\e[34m (n=#{report.on_free_sample_size})\e[0m\n"
      s << "\e[34m  - Latest: \e[36m#{report.latest_time_on_free.to_fs(:rounded, precision: 2)} days\e[34m (#{report.latest_converted_free_user.email} signed up #{time_ago_in_words(report.latest_converted_free_user.created)} ago)\e[0m\n"
      s << "\e[34m  - Average: \e[36m#{report.average_time_on_free.to_fs(:rounded, precision: 2)} days\e[0m\n"
      s << "\e[34m  - Median: \e[36m#{report.median_time_on_free.to_fs(:rounded, precision: 2)} days\e[0m\n"
      s << "\e[34m  - P90: \e[36m#{report.p90_time_on_free.to_fs(:rounded, precision: 2)} days\e[0m\n"
      s << "\e[34m  - P95: \e[36m#{report.p95_time_on_free.to_fs(:rounded, precision: 2)} days\e[0m\n"
      s << "\e[34m  - P99: \e[36m#{report.p99_time_on_free.to_fs(:rounded, precision: 2)} days\e[0m\n"
      s << "\e[34mUsers:\e[0m\n"
      s << "\e[34m  - Active: \e[32m#{report.total_active_accounts.to_fs(:delimited)}\e[34m (API usage over last 90 days, #{report.active_paid_accounts_percentage.to_fs(:percentage, precision: 2)} of paid, #{report.active_free_accounts_percentage.to_fs(:percentage, precision: 2)} of free)\e[0m\n"
      ...
      s << "\e[34m  - Free: \e[36m#{report.free_users.to_fs(:delimited)}\e[34m (#{report.free_users_percentage.to_fs(:percentage, precision: 2)} of all users, #{report.active_free_accounts_percentage.to_fs(:percentage, precision: 2)} active last 90 days)\e[0m\n"
  ...
  task churn: :environment do
    Rails.logger.silence do
      ...
      s << "\e[34m======================\e[0m\n"
      s << "\e[34mLost Revenue: \e[31m#{lost_revenue.to_fs(:currency)}/mo\e[0m\n"
      s << "\e[34mChurn Rate: \e[31m#{churn_rate.to_fs(:percentage, precision: 2)}\e[0m\n"
      ...
      at_risk_subscriptions.each do |subscription|
        ...
        s << "\e[34m  - \e[33m#{customer.email}\e[34m is at-risk (LT=#{life_time.to_fs(:rounded, precision: 2)}mo LTV=#{life_time_value.to_fs(:currency)})\e[0m\n"
      end
      ...
      canceling_subscriptions.each do |subscription|
        ...
        s << "\e[34m  - \e[31m#{customer.email}\e[34m is canceling (LT=#{life_time.to_fs(:rounded, precision: 2)}mo LTV=#{life_time_value.to_fs(:currency)})\e[0m\n"
      end
      ...
      churned_subscriptions.each do |subscription|
        ...
        s << "\e[34m  - \e[31m#{customer.email}\e[34m canceled #{time_ago_in_words(subscription.canceled_at || subscription.ended_at)} ago (LT=#{life_time.to_fs(:rounded, precision: 2)}mo LTV=#{life_time_value.to_fs(:currency)})\e[0m\n"
      end
