...
#          v1_account_license_tokens GET    /v1/accounts/:account_id/licenses/:license_id/tokens(.:format)          api/v1/licenses/relationships/tokens#index {:subdomain=>"api", :format=>"jsonapi", :license_id=>/[^\/]*/}
#           v1_account_license_token GET    /v1/accounts/:account_id/licenses/:license_id/tokens/:id(.:format)      api/v1/licenses/relationships/tokens#show {:subdomain=>"api", :format=>"jsonapi", :id=>/[^\/]*/, :license_id=>/[^\/]*/}
...
#          tokens_v1_account_license POST   /v1/accounts/:account_id/licenses/:id/tokens(.:format)                  api/v1/licenses/relationships/tokens#generate {:subdomain=>"api", :format=>"jsonapi", :id=>/[^\/]*/}
