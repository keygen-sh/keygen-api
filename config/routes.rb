...
#                                  GET    /.well-known/acme-challenge(.:format)                                #<Proc:0x007ff16ba32370@/Users/EzekielGabrielse/keygen/api/config/routes.rb:3 (lambda)>
#                        v1_stripe POST   /v1/stripe(.:format)                                                 api/v1/stripe#receive_webhook {:subdomain=>"api", :format=>"jsonapi"}
#                        v1_health GET    /v1/health(.:format)                                                 #<Proc:0x007ff16c5ae910@/Users/EzekielGabrielse/keygen/api/config/routes.rb:14 (lambda)> {:subdomain=>"api", :format=>"jsonapi"}
