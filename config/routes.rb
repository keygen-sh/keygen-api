...
#                                  GET    /.well-known/acme-challenge(.:format)                                #<Proc:0x007f8ea5aa45c0@/Users/gabrielse/code/keygen/api/config/routes.rb:3 (lambda)>
#                        v1_stripe POST   /v1/stripe(.:format)                                                 api/v1/stripe#receive_webhook {:subdomain=>"api", :format=>"jsonapi"}
#                        v1_health GET    /v1/health(.:format)                                                 #<Proc:0x007f8ea5ae69c0@/Users/gabrielse/code/keygen/api/config/routes.rb:14 (lambda)> {:subdomain=>"api", :format=>"jsonapi"}
