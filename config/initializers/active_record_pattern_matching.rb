...
##
# NOTE(ezekg) See: https://github.com/rails/rails/pull/45070
module ActiveRecord
...
ActiveRecord::Relation.include ActiveRecord::PatternMatching::Relation
ActiveRecord::Base.include ActiveRecord::PatternMatching::Record
ActiveModel::Model.include ActiveModel::PatternMatching::Attributes
