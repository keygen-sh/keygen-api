...
Feature: Rubygems compact index
  Background:
    ...
    And I send the following raw headers:
      """
      User-Agent: bundler/2.5.13 rubygems/3.5.11 ruby/3.3.4 (x86_64-pc-linux) command/install options/gem.changelog,gem.ci,gem.coc,gem.linter,gem.mit,gem.test,no_install 7242ad28c5b0aa90
      Accept: text/plain
      """
