@api/v1
Feature: Tauri v2 upgrade application
  Background:
    ...
    And the current account has the following "artifact" rows:
      ...
      | c1f8705e-68cd-4312-b2b1-72e19df47bd1 | 757e0a41-835e-42ad-bad8-84cabd29c72a | myapp.AppImage.sig   | sig      | linux    | x86_64 | PGXlpwysSCW2qsWXwBHeBWAlUP+s0E3mhUufAHpU9IpIjIufWDVbu9/8GTuxCKvElDcq/b59HnwNSDXx4deOLw== |
      ...
      | 1cccff81-8b49-40b2-9453-3456f2ca04ac | 757e0a41-835e-42ad-bad8-84cabd29c72a | myapp-setup.exe.sig  | sig      | windows  | x86_64 | tOfzZilkppAQWhtT6buV7tZUdzDNOZK1YjNkslSSafzsvsuQmSbk9XfXXQEeF1iSgbM+x8fGlCcTjuBDSZZS1Q== |
      ...
      | a2fd1960-54c6-4624-83d1-84f0c8dd1f1a | 757e0a41-835e-42ad-bad8-84cabd29c72a | myapp.msi.sig        | sig      | windows  | x86_64 | xlHIObWDYsjaYOl1EZEGGfkpi1DlT8/73vkJ2gBdFKQBcPJa4iwI4887vQnfi65fH+s3ptcOjmrtiiRnqTTt4w=  |
      # 1.1.0
      ...
      | 394180bd-4e0d-4d1b-986d-e4befad92101 | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | myapp.AppImage.sig   | sig      | linux    | x86_64 | Lc4r8JwhtfB7y9AhQ48uQiITGBXeockeMrsZU6kFk9dSF0dAi6SDWCFUsrJbUYPRhN2eduQdk8fHq0GwRD/dgw== |
      ...
      | ba8dd592-2c3e-46bf-afdc-dabc2fed9d8e | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | myapp-setup.exe.sig  | sig      | windows  | x86_64 | gBbZS6U0bu6lDtfT0ntoATXijot9PwCTj38rSD0Np7Vs6Jh73oL7caa9Td4MFHq/wt1t70gLPPaHoNvOWEN+2w== |
      ...
      | c185d92b-1232-4bdd-9906-fa4d99e259c7 | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | myapp.msi.sig        | sig      | windows  | x86_64 | DbSIbY2X0YRCySCC+xQeeber/9A45KZxHSyjNh4FSfQRkbK/jTCZ+MpIZ7geWu4Jx0FVq+7R9qj8Gtiz3TaEYg== |
      # 1.2.0-beta.1
      ...
      | 419ba987-9184-4baf-82bf-8ca9baa4e267 | 2bbb14ae-bb6b-4c57-b6ab-26f7982c967d | myapp-setup.exe.sig  | sig      | windows  | x86_64 | uAAQVTGXau6Y6WNUIHBEzahPFn34E6poG78Ip9Bc9urgLuTzZgyQAaohS6nU4wuQdftUTwZbVxpYpXlAh/fDbg== |
      ...
      | d2801d8a-5ce8-4c48-89ee-7177d7dcc84c | 2bbb14ae-bb6b-4c57-b6ab-26f7982c967d | myapp.msi.sig        | sig      | windows  | x86_64 | uUsbx9f9ZGlN/45rBK3ZRy7/QNJNdsyG5f18dIt1FO0caAPr5cBxBIuUAbmIC7FnrECrDLcaL18GQ8MeB86WOA== |
      # 1.0.0-beta.1
      ...
      | f36df79d-5952-4d7d-ae13-87198e1cd0f0 | c77ba874-de62-4a17-8368-fc10db1e1c80 | myapp-setup.exe.sig  | sig      | windows  | i686   | nr20BEyN5xnWX3I+OxDX85GhGoABpvJGevnmo95nBdHdxFxKCQMLRwQaVqCh++RRRAWv22Hq1VZcxpwumOwuLw== |
      ...
      | ecdb59f6-00c1-4fec-80bd-7fc176f9d1a0 | c77ba874-de62-4a17-8368-fc10db1e1c80 | myapp.msi.sig        | sig      | windows  | i686   | qJ6ij921jgD6yJ3UknE5IFAiSfFPTcUZPkqGj+WwfedTKPz7d7NmiUZRxPoajz/GKLimBoXdEm0a57L+yFEejw== |
      # 1.0.1-beta.1
      ...
      | cefb4032-6e1b-4411-8e85-f5d7d8a269a2 | 29f74047-265f-452c-9d64-779621682857 | myapp-setup.exe.sig  | sig      | windows  | i686   | dA4En1FgSfi+6O8O+DY5bCchQkVxRGR8w+4pKfGjpug6+/4wwrZgmlhOfs364eKVtf7UcWsZ9vopF0E6HV28UA== |
      ...
      | 2986a294-fc70-4a99-805e-e91b90b4ec2b | 29f74047-265f-452c-9d64-779621682857 | myapp.msi.sig        | sig      | windows  | i686   | CW5imayiWMU50dYJIW1CMDxMW0qr01YUGd97r4IOs2WZlpcl1OIyeYvKgDNAJXkBBSbi9QPG21I3OxJxecsoBw== |
      # 2.0.0-beta.1
      ...
      | e1a9d063-cd8d-4655-95e5-647c961852eb | 972aa5b8-b12c-49f4-8ba4-7c9ae053dfa2 | myapp-setup.exe.sig  | sig      | windows  | i686   | Rpvx4kMZlfBr1lM7GwA1tJA7qeRGfNACOIYXwyxqTH6RkqIvcNcB8dl3ZcdEqdF46l1oFDiWYcI5xYE35/NSlA== |
      ...
      | dd61752e-187e-4346-a7df-fda80adb7131 | 972aa5b8-b12c-49f4-8ba4-7c9ae053dfa2 | myapp.msi.sig        | sig      | windows  | i686   | /oBea3DwxhueGOhoKQ9JxTBHamr9cp85WyJI5p50FeRqq9zELjroza7h5/c33CgZGnx1klSo4omAqWgdupx+8g== |
  ...
  Scenario: Endpoint should return an upgrade when an upgrade is available
    ...
    And the response body should include the following:
      """
      {
        "url": "https://api.keygen.sh/v1/accounts/$account/artifacts/00aeec65-165c-487c-8e22-7ab454319b0f/myapp.AppImage",
  ...
  Scenario: Endpoint should prefer NSIS over MSI for windows
    ...
    And the response body should include the following:
      """
      {
        "url": "https://api.keygen.sh/v1/accounts/$account/artifacts/16b9a3fa-6b12-4d86-b81e-be2757392bae/myapp-setup.exe",
        "signature": "1/ZheqnqL3OJbQcUa+zmFCENiXqhW1oqrUP2sREyExryaDRcy14lC6nSHg4gt/TfbHkE1ANnsEFizRdno+uZZg==",
  ...
  Scenario: Endpoint should constrain to a semver constraint
    ...
    And the response body should include the following:
      """
      {
        "url": "https://api.keygen.sh/v1/accounts/$account/artifacts/05b82ab6-ad64-46d4-9885-97a23347eb1c/myapp-setup.exe",
        "signature": "w3tDl0PCRIBM8t07D8fWpl102zpxiKKYJ8E6oCLBxiXYBB3Zvb52osFgrw6H8nPrqNu3Ax0NV8VKtBmmxxUN3A==",
  ...
  Scenario: Endpoint should upgrade from stable to beta
    ...
    And the response body should include the following:
      """
      {
        "url": "https://api.keygen.sh/v1/accounts/$account/artifacts/05f8a823-b80b-4453-a524-82332fc50792/myapp.AppImage",
        "signature": "Zd9e9c4l6Z1pHJPjFzYSWKLmzaQG1d/80hWMM5QbcnBBdNzObcJFGbmXJzAzrNRI1F9K6npGWlCFLZikvFm4rA==",
  ...
  Scenario: Product retrieves an upgrade when an upgrade is available
    ...
    And the response body should include the following:
      """
      {
        "url": "https://api.keygen.sh/v1/accounts/$account/artifacts/2133955c-137f-4422-9290-9a364b1a40a0/myapp-setup.exe",
        "signature": "BQfSyTfYWnHrl7LywK/fcioco+6IM4y1ermCGf5MjV1HT9VZ5ZtWRlQUM0UrPEXZct/gFYOf/THLk7mTvLUw1A==",
        "version": "1.1.0"
      }
      """
