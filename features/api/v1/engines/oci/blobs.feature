...
Feature: OCI image blobs
  ...
  Scenario: Product retrieves their draft blob
    Given the current account is "microsoft"
    And I am product "windows" of account "microsoft"
    And I use an authentication token
    When I send a GET request to "/accounts/microsoft/engines/oci/windows/blobs/sha256:40f923622162df3ece7602a0d41ee7920aaf3c978ca9e9f9aa4dc7b34af2e229"
    Then the response status should be "303"
    And the response should contain the following raw headers:
      """
      Location: https://api.keygen.sh/v1/accounts/9f3d711d-55ea-49ed-9155-9acf4e4a347b/artifacts/2e8fc5fb-a57f-49e2-9484-77bb421dc758/blobs%2Fsha256%2F40f923622162df3ece7602a0d41ee7920aaf3c978ca9e9f9aa4dc7b34af2e229
      """

  Scenario: Product retrieves their yanked blob
    Given the current account is "microsoft"
    And I am product "windows" of account "microsoft"
    And I use an authentication token
    When I send a GET request to "/accounts/microsoft/engines/oci/windows/blobs/sha256:07f83d6bdf77359ea8d23fbb11ae297a9c8f4a85fe0403e34106353b04ae8b15"
    Then the response status should be "303"
    And the response should contain the following raw headers:
      """
      Location: https://api.keygen.sh/v1/accounts/9f3d711d-55ea-49ed-9155-9acf4e4a347b/artifacts/2da1858d-49eb-47e0-94cc-a94a0bba9453/blobs%2Fsha256%2F07f83d6bdf77359ea8d23fbb11ae297a9c8f4a85fe0403e34106353b04ae8b15
      """
  ...
  Scenario: License retrieves a draft blob
    Given the current account is "linux"
    And the current account has 1 "policy" for the first "product" with the following:
      """
      { "authenticationStrategy": "LICENSE" }
    ...
    And I am a license of account "linux"
    And I authenticate with my key
    When I send a GET request to "/accounts/linux/engines/oci/alpine/blobs/sha256:40f923622162df3ece7602a0d41ee7920aaf3c978ca9e9f9aa4dc7b34af2e229"
    Then the response status should be "404"

  Scenario: License retrieves a yanked blob
    Given the current account is "linux"
    And the current account has 1 "policy" for the first "product" with the following:
      """
      { "authenticationStrategy": "LICENSE" }
    ...
    And I am a license of account "linux"
    And I authenticate with my key
    When I send a GET request to "/accounts/linux/engines/oci/alpine/blobs/sha256:07f83d6bdf77359ea8d23fbb11ae297a9c8f4a85fe0403e34106353b04ae8b15"
    Then the response status should be "404"
  ...
  Scenario: User retrieves a draft blob
    Given the current account is "linux"
    And  the current account has 1 "user"
    And the current account has 1 "policy" for the first "product" with the following:
      """
  ...
  Scenario: User retrieves a yanked blob
    Given the current account is "linux"
    And  the current account has 1 "user"
    And the current account has 1 "policy" for the first "product" with the following:
      """
  ...
  Scenario: Anon retrieves a draft blob
    When I send a GET request to "/accounts/linux/engines/oci/alpine/blobs/sha256:40f923622162df3ece7602a0d41ee7920aaf3c978ca9e9f9aa4dc7b34af2e229"
    Then the response status should be "404"

  Scenario: Anon retrieves a yanked blob
    When I send a GET request to "/accounts/linux/engines/oci/alpine/blobs/sha256:07f83d6bdf77359ea8d23fbb11ae297a9c8f4a85fe0403e34106353b04ae8b15"
    Then the response status should be "404"
