...
Feature: List releases
  ...
  Scenario: User retrieves all releases for their products
    ...
    And the current account has 3 "releases" associated to the first "product"
    And the current account has 7 "releases" associated to the second "product"
    And the current account has 1 "policy" associated to the first "product"
    And the current account has 1 "license" associated to the first "policy"
  ...
  Scenario: License retrieves all releases for their product
    Given the current account is "test1"
    And the current account has 2 "products"
    And the current account has 9 "releases" associated to the first "product"
    And the current account has 5 "releases" associated to the second "product"
    And the current account has 1 "policy" associated to the first "product"
    And the current account has 1 "license" associated to the first "policy"
