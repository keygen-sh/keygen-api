...
Feature: List releases
  ...
  Scenario: Admin retrieves an offset-paginated list of releases
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 19 "releases"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page[number]=4&page[size]=5"
    Then the response status should be "200"
    And the response body should be an array with 4 "releases"
    And the response body should contain the following links:
      """
      {
        "self": "/v1/accounts/test1/releases?page[number]=4&page[size]=5",
        "prev": "/v1/accounts/test1/releases?page[number]=3&page[size]=5",
        "first": "/v1/accounts/test1/releases?page[number]=1&page[size]=5",
        "meta": {
          "pages": 4,
          "count": 19
        }
  ...
  Scenario: Admin retrieves an offset-paginated list of releases with a page size that is too high
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 19 "releases"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page[number]=1&page[size]=250"
    Then the response status should be "400"

  Scenario: Admin retrieves an offset-paginated list of releases with a page size that is too low
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 19 "releases"
    And I use an authentication token
  ...
  Scenario: Admin retrieves an offset-paginated list of releases with an invalid page number (negative)
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 19 "releases"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page[number]=-1&page[size]=10"
    Then the response status should be "400"

  Scenario: Admin retrieves an offset-paginated list of releases with an invalid page number (type)
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 19 "releases"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page%5Bnumber%5D%3D=0"
    Then the response status should be "400"

  Scenario: Admin retrieves an offset-paginated list of releases with a page number that is too high
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 19 "releases"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page[number]=101&page[size]=100"
    Then the response status should be "400"

  Scenario: Admin retrieves an offset-paginated list of releases with a page number that is too low
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 19 "releases"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page[number]=0&page[size]=100"
    Then the response status should be "400"

  Scenario: Admin retrieves a keyset-paginated list of releases (first page)
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 19 "releases"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page[size]=5&page[cursor]="
    Then the response status should be "200"
    And the response body should be an array with 5 "releases"
    And the response body should contain the following links:
      """
      {
        "self": "/v1/accounts/test1/releases?page[cursor]=&page[size]=5",
        "next": "/v1/accounts/test1/releases?page[cursor]=$releases[-5]&page[size]=5"
      }
      """

  Scenario: Admin retrieves a keyset-paginated list of releases (next page)
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 19 "releases"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page[size]=5&page[cursor]=$releases[-5]"
    Then the response status should be "200"
    And the response body should be an array with 5 "releases"
    And the response body should contain the following links:
      """
      {
        "self": "/v1/accounts/test1/releases?page[cursor]=$releases[-5]&page[size]=5",
        "next": "/v1/accounts/test1/releases?page[cursor]=$releases[-10]&page[size]=5"
      }
      """

  Scenario: Admin retrieves a keyset-paginated list of releases (last page)
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 19 "releases"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page[size]=5&page[cursor]=$releases[-15]"
    Then the response status should be "200"
    And the response body should be an array with 4 "releases"
    And the response body should contain the following links:
      """
      {
        "self": "/v1/accounts/test1/releases?page[cursor]=$releases[-15]&page[size]=5",
        "next": null
      }
      """

  Scenario: Admin retrieves a keyset-paginated list of releases (no results)
    Given I am an admin of account "test1"
    And the current account is "test1"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page[size]=5&page[cursor]="
  ...
  Scenario: Admin retrieves a keyset-paginated list of releases (nonexistent cursor)
    Given I am an admin of account "test1"
    And the current account is "test1"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page[size]=5&page[cursor]=52a26820-0caa-4bac-9ff1-27bb6ec77ac4"
    Then the response status should be "200"
    And the response body should be an array with 0 "releases"
    And the response body should contain the following links:
      """
      {
        "self": "/v1/accounts/test1/releases?page[cursor]=52a26820-0caa-4bac-9ff1-27bb6ec77ac4&page[size]=5",
        "next": null
      }
      """

  Scenario: Admin retrieves a keyset-paginated list of releases (invalid cursor)
    Given I am an admin of account "test1"
    And the current account is "test1"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?page[size]=5&page[cursor]=foo"
    Then the response status should be "400"
  ...
  Scenario: License retrieves a keyset-paginated list of releases (first page)
    Given the current account is "test1"
    And the current account has 1 "product"
    And the current account has 1 "policy" for the last "product"
    And the current account has 19 "releases" for the last "product"
  ...
  Scenario: License retrieves a keyset-paginated list of releases (next page)
    Given the current account is "test1"
    And the current account has 1 "product"
    And the current account has 1 "policy" for the last "product"
    And the current account has 19 "releases" for the last "product"
  ...
  Scenario: License retrieves a keyset-paginated list of constrained releases (first page)
    Given the current account is "test1"
    And the current account has 1 "product"
    And the current account has 1 "policy" for the last "product"
    And the current account has 19 constrained "releases" for the last "product"
  ...
  Scenario: License retrieves a keyset-paginated list of constrained releases (next page)
    Given the current account is "test1"
    And the current account has 1 "product"
    And the current account has 1 "policy" for the last "product"
    And the current account has 19 constrained "releases" for the last "product"
  ...
  Scenario: License retrieves their product releases with constraints (with filters)
    Given the current account is "test1"
    And the current account has 3 "entitlements"
    And the current account has 1 "product"
    And the current account has 3 "releases" for the last "product"
    ...
    And I am a license of account "test1"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/releases?product=$products[0]&entitlements[]=$entitlements[1].code"
    Then the response status should be "200"
    And the response body should be an array with 1 "release"
