...
Feature: Machine components relationship
  ...
  # Index
  Scenario: Admin retrieves an offset-paginated list of components for a machine with no other pages
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 1 "machine"
  ...
  Scenario: Admin retrieves an offset-paginated list of components for a machine with other pages
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has 1 "machine"
