...
Feature: Analytic counts
  ...
  Scenario: Admin retrieves analytic counts for their account
    ...
    # | user_id  | license_ids        |
    # |:---------|:-------------------|
    # | nil      | 09d2e554, 69e2c722 |
    # | 08c7f078 | ee26deca           |
    # | 176bd46a | 894f1d07           |
    # | 2b8dcb3b | af5c7d44           |
    # | 31e7d077 | df0beed9           |
    # | 44dce69e | ee26deca           |
    # | 4dface92 | 12b570c9, ce5fc968 |
    # | 5e360440 | 12b570c9           |
    # | 6a0e6577 | ce5fc968           |
    # | 80c38300 | e5bdae6f           |
    # | a04ac105 | e4304d3f           |
    ...
    # |:-----------|:-----------------------------|
    # | 09d2e554   |                              |
    # | 12b570c9   | 4dface92, 5e360440, be3ea9f0 |
    # | 69e2c722   |                              |
    # | 894f1d07   | 176bd46a                     |
    # | af5c7d44   | 2b8dcb3b                     |
    # | ce5fc968   | 4dface92, 6a0e6577, b2966243 |
    # | df0beed9   | 31e7d077                     |
    # | e4304d3f   | a04ac105                     |
    # | e5bdae6f   | 80c38300                     |
    # | ee26deca   | 08c7f078, 44dce69e           |
    #
    And the response body should contain meta with the following:
      """
      {
        "activeLicensedUsers": 14,
        "activeLicenses": 10,
        "totalLicenses": 16,
        "totalMachines": 4,
        "totalUsers": 18
