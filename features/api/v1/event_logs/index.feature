...
Feature: List event logs
  ...
  Scenario: Admin retrieves all logs for their Std account
    ...
    And the following "event-type" rows exist:
      ...
      | e341b8c3-c9ad-46ec-b1ea-43fd351a80ae | test.billing.updated              |
    ...
    And the current account has the following "event-log" rows:
      ...
      | User           | 54a44eaf-6a83-4bb4-b3c1-17600dfdd77c | caf802b2-9ddc-498b-8061-36309a05ca42 | Machine       | 19ac6439-5576-4ba8-92cd-f4c17573159e |
      ...
      | User           | 54a44eaf-6a83-4bb4-b3c1-17600dfdd77c | e341b8c3-c9ad-46ec-b1ea-43fd351a80ae | Billing       | 0ee021c7-b384-4cf1-97fe-fdb5c5b473fc |
    And I use an authentication token
  ...
  Scenario: Admin retrieves a list of logs filtered by events
    Given I am an admin of account "ent"
    And the current account is "ent"
    And the following "event-type" rows exist:
      | id                                   | event                             |
    ...
    And the current account has the following "event-log" rows:
      ...
      | User           | 54a44eaf-6a83-4bb4-b3c1-17600dfdd77c | e341b8c3-c9ad-46ec-b1ea-43fd351a80ae | Billing       | 0ee021c7-b384-4cf1-97fe-fdb5c5b473fc |
    And I use an authentication token
    When I send a GET request to "/accounts/ent/event-logs?events[]=test.license.validation.succeeded&events[]=test.license.validation.failed"
    Then the response status should be "200"
    And the response body should be an array with 4 "event-logs"
