...
Feature: Event gauge analytics
  ...
  Scenario: Endpoint should be accessible when account is disabled
    ...
    When I send a GET request to "/accounts/test1/analytics/gauges/events/license.created"
    Then the response status should be "200"
    And sidekiq should have 0 "request-log" jobs
    And sidekiq should have 0 "event-log" jobs

  Scenario: Admin retrieves event gauge for a specific event type
    Given I am an admin of account "test1"
    And the current account is "test1"
    ...
    And the current account has the following "event_log" rows:
      ...
      | 31e30cc1-d454-40dc-b4ae-93ad683ddf33 | license.created | License       | c29fc20f-ec09-4cf4-8145-f910109e5705 |
      | d1e6f594-7bcb-455f-971b-1e8b3ea63fd7 | license.deleted | License       | c29fc20f-ec09-4cf4-8145-f910109e5705 |
    And I use an authentication token
    When I send a GET request to "/accounts/test1/analytics/gauges/events/license.created"
    Then the response status should be "200"
    And the response body should be a JSON document with the following content:
      ...
      {
        "data": [
          { "metric": "events.license-created", "count": 3 }
        ]
      }
      """
    And sidekiq should have 0 "request-log" jobs
  ...
  Scenario: Admin retrieves event gauge with wildcard pattern
    Given I am an admin of account "test1"
    And the current account is "test1"
    And the current account has the following "license" rows:
      | id                                   | name      |
    ...
    And I use an authentication token
    When I send a GET request to "/accounts/test1/analytics/gauges/events/license.validation.*"
    Then the response status should be "200"
    And the response body should be a JSON document with the following content:
      """
      {
        "data": [
          { "metric": "events.license-validation-failed", "count": 2 },
          { "metric": "events.license-validation-succeeded", "count": 3 }
        ]
      }
      """
    And sidekiq should have 0 "request-log" jobs
  ...
  Scenario: Admin retrieves event gauge with no data
    Given I am an admin of account "test1"
    And the current account is "test1"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/analytics/gauges/events/license.created"
  ...
  Scenario: Admin retrieves event gauge for isolated environment
    ...
    And the current account has the following "event_log" rows:
      | id                                   | environment_id                       | event           | resource_type | resource_id                          |
      | 52785862-2da1-47a2-a6d7-be93743a12c1 | bf20fe24-351d-47d0-b3c3-2c576a63d22f | license.created | License       | d00998f9-d224-4ee7-ac4e-f1e5fe318ff7 |
      | 533cb423-17e2-4641-8140-5dddfb0cd98c | bf20fe24-351d-47d0-b3c3-2c576a63d22f | license.created | License       | d00998f9-d224-4ee7-ac4e-f1e5fe318ff7 |
      | ff3569df-0a9e-400c-8d47-c93d042b67e7 | 60e7f35f-5401-4cc2-abd3-999b2a758ee1 | license.created | License       | 19a9aefc-00b9-4905-b236-ff3cca788b3e |
      | d64a411f-a3c8-4136-bc82-d42d346668ef | 60e7f35f-5401-4cc2-abd3-999b2a758ee1 | license.created | License       | 31e30cc1-d454-40dc-b4ae-93ad683ddf33 |
      | 56ac9ab0-ae64-47bc-ab3a-1c4437aba9f8 |                                      | license.created | License       | 09d7a1f9-3c4a-401f-b6a9-839f4e35d493 |
    ...
    And the response body should be a JSON document with the following content:
      ...
      {
        "data": [
          { "metric": "events.license-created", "count": 2 }
        ]
      }
      """
    And sidekiq should have 0 "request-log" jobs
  ...
  Scenario: Admin retrieves event gauge for shared environment
    Given the current account is "test1"
    And the current account has the following "environment" rows:
      | id                                   | name     | code     | isolation_strategy |
      | bf20fe24-351d-47d0-b3c3-2c576a63d22f | Isolated | isolated | ISOLATED           |
    ...
    And the current account has the following "license" rows:
      ...
      | 09d7a1f9-3c4a-401f-b6a9-839f4e35d493 |                                      | 07b5b667-9d09-4f0b-a433-9cfff4111b61 |
    And the current account has the following "event_log" rows:
      | environment_id                       | event           | resource_type | resource_id                          |
      | bf20fe24-351d-47d0-b3c3-2c576a63d22f | license.created | License       | d00998f9-d224-4ee7-ac4e-f1e5fe318ff7 |
      | bf20fe24-351d-47d0-b3c3-2c576a63d22f | license.created | License       | d00998f9-d224-4ee7-ac4e-f1e5fe318ff7 |
      | 60e7f35f-5401-4cc2-abd3-999b2a758ee1 | license.created | License       | 19a9aefc-00b9-4905-b236-ff3cca788b3e |
      | 60e7f35f-5401-4cc2-abd3-999b2a758ee1 | license.created | License       | 31e30cc1-d454-40dc-b4ae-93ad683ddf33 |
      |                                      | license.created | License       | 09d7a1f9-3c4a-401f-b6a9-839f4e35d493 |
      | 60e7f35f-5401-4cc2-abd3-999b2a758ee1 | license.created | License       | 09d7a1f9-3c4a-401f-b6a9-839f4e35d493 |
    And the current account has 1 shared "admin"
    And I am the last admin of account "test1"
    And I use an authentication token
    When I send a GET request to "/accounts/test1/analytics/gauges/events/license.created?environment=shared"
    Then the response status should be "200"
    And the response body should be a JSON document with the following content:
      """
      {
        "data": [
          { "metric": "events.license-created", "count": 4 }
        ]
      }
      """
    And sidekiq should have 0 "request-log" jobs
  ...
  Scenario: Admin retrieves event gauge for global environment
    Given the current account is "test1"
    And the current account has the following "environment" rows:
      | id                                   | name     | code     | isolation_strategy |
      | bf20fe24-351d-47d0-b3c3-2c576a63d22f | Isolated | isolated | ISOLATED           |
    ...
    And the response body should be a JSON document with the following content:
      ...
      {
        "data": [
          { "metric": "events.license-created", "count": 1 }
        ]
      }
      """
    And sidekiq should have 0 "request-log" jobs
  ...
  Scenario: Product attempts to retrieve event gauge for their account
    Given the current account is "test1"
  ...
  Scenario: User attempts to retrieve event gauge for their account
    Given the current account is "test1"
  ...
  Scenario: License attempts to retrieve event gauge for their account
    Given the current account is "test1"
